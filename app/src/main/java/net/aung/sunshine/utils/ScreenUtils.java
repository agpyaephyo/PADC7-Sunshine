...
public class ScreenUtils {
    ...
    public static void setTransparent (boolean isToTranslucent, Activity activity) {
        if(isToTranslucent){
    ...
    public static void setTransparentNavigator(boolean isToTranslucent, Activity activity) {
        if(isToTranslucent){
            Window w = activity.getWindow();
            w.setFlags(
                    WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION,
