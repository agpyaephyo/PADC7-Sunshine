...
public class WeatherDataUtils {
    ...
    public static void loadWeatherDescMap() {
        Context context = SunshineWearApp.getContext();
    ...
    public static int getBackgroundResourceIdForWeatherCondition(int weatherId) {
        // Based on weather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
            return R.drawable.bg_200_232;
        } else if (weatherId >= 300 && weatherId <= 321) {
            return R.drawable.bg_300_321;
        } else if (weatherId >= 500 && weatherId <= 504) {
            return R.drawable.bg_500_504;
        } else if (weatherId == 511) {
            return R.drawable.bg_511;
        } else if (weatherId >= 520 && weatherId <= 531) {
            return R.drawable.bg_520_531;
        } else if (weatherId >= 600 && weatherId <= 622) {
            return R.drawable.bg_600_622;
        } else if (weatherId >= 701 && weatherId <= 761) {
            return R.drawable.bg_701_761;
        } else if (weatherId == 761 || weatherId == 781) {
            return R.drawable.bg_761_781;
        } else if (weatherId == 800) {
            return R.drawable.bg_800;
        } else if (weatherId == 801) {
            return R.drawable.bg_801;
        } else if (weatherId >= 802 && weatherId <= 804) {
            return R.drawable.bg_802_804;
        }
        return -1;
    }
}
